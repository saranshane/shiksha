...
<section class="watch-video">
   ...
   <div class="video-details">
      ...
      <strong><h2>Quiz </h2></Strong>
      <div class="description"><p><?= $fetch_content['quizlink']; ?></p></div>
      <strong><h2>Lab </h2></Strong>
      <div class="description"><p><?= $fetch_content['lablink']; ?></p></div>
   </div>
   <?php
         }
      }else{
