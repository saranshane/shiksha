...
if(isset($_POST['update'])){
   ...
   $update_content = $conn->prepare("UPDATE `content` SET title = ?, description = ?, quizlink = ?, lablink = ?, status = ? WHERE id = ?");
   $update_content->execute([$title, $description,$quizlink,  $lablink, $status, $video_id]);
...
<section class="video-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>update playlist</p>
      <p>update quizlink <span>*</span></p>
      <input type="text" name="quizlink" maxlength="100" required placeholder="enter quizlink" class="box">
      <p>update lablink <span>*</span></p>
      <input type="text" name="lablink" maxlength="100" required placeholder="enter quizlink" class="box">
